 ...
 */
class MBJ_PayPal_Payment_PayPal_listner {
    ...
    public function successful_request($IPN_status) {
        ...
        do_action('paypal_payment_send_notification_mail', $posted);
    ...
    public function ipn_response_data_handler($posted = null) {
        ...
        if (isset($posted) && !empty($posted)) {
            ...
            if ($this->paypal_payment_exist_post_by_title($paypal_txn_id) == false) {
                ...
                if ('yes' == get_option('enable_mailchimp')) {
                    do_action('paypal_payment_mailchimp_handler', $posted);
                }
                ...
                $post_id = $this->paypal_payment_exist_post_by_title($paypal_txn_id);
    ...
    /**
     * paypal_payment_exist_post_by_title helper function used for check txn_id as post_title is exist or not
     * @since    1.0.0
     * @access   public
     */
    function paypal_payment_exist_post_by_title($ipn_txn_id) {
