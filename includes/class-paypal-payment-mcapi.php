...
/**
 * @class       MBJ_PayPal_Payment_Html_output_MailChimp_MCAPI
 * @version	1.0.0
 * @package	paypal-payment
 * @category	Class
 * @author      johnny manziel <phpwebcreators@gmail.com>
 */
class MBJ_PayPal_Payment_MailChimp_MCAPI {
     ...
     */
    function MBJ_PayPal_Payment_MailChimp_MCAPI($apikey, $secure = false) {
        $this->secure = $secure;
